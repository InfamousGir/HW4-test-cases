...
public abstract class BoardGUIBase extends VBox {
    ...
    protected abstract void uttonAction(javafx.event.ActionEvent actionEvent);

    protected abstract void buttonAction(javafx.event.ActionEvent actionEvent);
